# Приложение для расчёта геометрической задачи для варианта №11

Приложение должно позволять по введённым координатам двух смежных вершин прямоугольника $(x_1, y_1)$ и $(x_2, y_2)$
и радиусу $R$ описанной вокруг этого прямоугольника окружности вычислять координаты оставшихся двух вершин
прямоугольника, а также координаты центра описанной вокруг прямоугольника окружности. Приложение должно выводить оба
возможных варианта.
...
* Четыре поля для ввода координат $x_1$, $y_1$, $x_2$, $y_2$ и поле для ввода радиуса $R$. Поля обязательны для
  заполнения и должны содержать вещественные числа. При этом точки $(x_1, y_1)$ и $(x_2, y_2)$ не должны совпадать, а
  радиус $R$ должен быть положительным.
...
* координаты всех четырёх вершин прямоугольника для первого варианта;
* координаты центра и радиус описанной вокруг прямоугольника окружности для первого варианта;
* координаты всех четырёх вершин прямоугольника для второго варианта;
* координаты центра и радиус описанной вокруг прямоугольника окружности для второго варианта.
